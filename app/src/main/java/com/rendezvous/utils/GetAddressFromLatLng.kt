    ...
    override fun doInBackground(vararg params: Void?): String {
        try {
            ...
            if (addressList != null && addressList.isNotEmpty()) {
                ...
                sb.deleteCharAt(sb.length - 1) // Here I remove the last comma that I have added above from the address.
                return sb.toString()
            }
        } catch (e: IOException) {
            Log.e("Rendezvous", "Unable connect to Geocoder")
        }
